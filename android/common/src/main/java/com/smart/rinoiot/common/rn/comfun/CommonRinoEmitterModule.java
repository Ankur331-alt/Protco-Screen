 ...
 * @Version: 1.0
 */
public class CommonRinoEmitterModule extends ReactContextBaseJavaModule implements EventListener, LifecycleEventListener {

    public CommonRinoEmitterModule(@Nullable ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void onHostResume() {
        CommonEventManager.getInstance().setOnEventListener(this);
    }
    ...
    public void onHostDestroy() {
        ...
        CommonEventManager.getInstance().removeListener();
    }
