...
public abstract class BaseSectionFragmentRecyclerView<T extends ViewBinding, M extends BaseViewModel, V extends SectionEntity> extends BaseFragment<T, M> {

    protected RecyclerView recyclerView;
    protected SwipeRefreshLayout swipeRefreshLayout;
    protected PageInfo pageInfo = new PageInfo();
    protected BaseSectionAdapter<V> adapter;

    protected abstract BaseSectionAdapter<V> createRecycleViewAdapter();
