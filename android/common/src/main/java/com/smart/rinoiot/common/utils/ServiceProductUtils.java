...
//            Constant.BASE_URL_H5 = "https://test.rinoiot.com/";
            ...
            // 印度测试环境
            Constant.API_HOSTNAME = "testservice.protco.in";
            Constant.AUTHORIZATION_ID = "rinoiot-iot-app";
            Constant.AUTHORIZATION_PASSWORD = "olADJCmWlFIVXY1q1lx0wUrUbze7XweR";
            Constant.AES_APPID = "us7rwpd8wlv9b9";
            Constant.BASE_URL = (isEmptyHost ? "https://testservice.protco.in" : hostUrl) + "/api/";
            Constant.MQTT_HOST_URL = isEmptyMqtt ? "testmqtt.protco.in" : mqttId;
            Constant.WEB_SOCKET_HOST_URL = "ws-miffy.iprodigytec.com";
            Constant.BASE_URL_H5 = "https://testh5.protco.in/";
