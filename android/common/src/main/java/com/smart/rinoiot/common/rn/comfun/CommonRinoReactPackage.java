...
import com.smart.rinoiot.common.rn.RinoDeviceModule;
import com.smart.rinoiot.common.rn.RinoNativeModule;
import com.smart.rinoiot.common.rn.RinoNetworkModule;
 ...
 * @Version: 1.0
 */
public class CommonRinoReactPackage implements ReactPackage {
...
//    }
    ...
    public @NotNull List<NativeModule> createNativeModules(
        ...
        modules.add(new CommonRinoEmitterModule(reactContext));
