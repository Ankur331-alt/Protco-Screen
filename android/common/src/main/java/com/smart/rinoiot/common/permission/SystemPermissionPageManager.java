...
/**
 * @author tw
 * @time 2023/3/29 17:22
 * @descriptionAndroid 应用跳转系统权限设置页面，适配各种手机ROM
 * 目前测试了一加，小米，VIVO，华为（鸿蒙只能跳转系统设置页，无法跳转应用权限）
 */
public class SystemPermissionPageManager {

    private static final String TAG = SystemPermissionPageManager.class.getSimpleName();
...
//                LgUtils.e(TAG + "goToSetting  目前暂不支持此系统");
//                break;
//        }
    }
