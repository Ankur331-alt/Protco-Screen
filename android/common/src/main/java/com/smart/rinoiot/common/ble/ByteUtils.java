...
public class ByteUtils {
     ...
     * Gets a pretty representation of a Byte Array as a HEX String.
     * <p>
     * Sample output: 0130FFAA
     *
     * @param array the array
     * @return the string
     */
    public static String byteArrayToHexString2(final byte[] array) {
        final StringBuilder sb = new StringBuilder();
    ...
    public static String byteArrayToString(byte[] buffer) {
        try {
            ...
            e.printStackTrace();
            Log.w("TAG==","onScanResult:  解析11：byteArrayToString 异常  "+e.getMessage());
            return "";
        }
    }
    ...
    public static byte[] subBytes(byte[] src, int begin, int count) {
        try {
            ...
            e.getMessage();
            Log.w("TAG==","onScanResult:  解析11：subBytes 异常  "+e.getMessage());
        }
        return null;
    }
