...
public class BleOtaUpdater implements OtaListener {
    ...
    private final Handler mHandler;//Main thread object
    ...
    private final Runnable mUpdateRunnable;//Execute thread
    ...
    public BleOtaUpdater(Handler handler) {
        ...
        this.mUpdateRunnable = () -> BleOtaUpdater.this.otaUpdateProcess(BleOtaUpdater.this.mFilePath);
    }
