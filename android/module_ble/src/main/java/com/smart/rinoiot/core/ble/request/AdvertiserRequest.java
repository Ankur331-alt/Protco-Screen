...
import com.smart.rinoiot.core.ble.BleHandler;
import com.smart.rinoiot.core.ble.BleLog;
import com.smart.rinoiot.core.ble.annotation.Implement;
import com.smart.rinoiot.core.ble.exception.AdvertiserUnsupportException;
...
public class AdvertiserRequest<T extends BleDevice> {
    ...
    private final Handler mHandler = BleHandler.of();
    ...
    private final Runnable stopAvertiseRunnable = this::stopAdvertising;
