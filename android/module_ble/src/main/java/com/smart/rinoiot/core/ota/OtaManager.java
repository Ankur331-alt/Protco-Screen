...
import com.smart.rinoiot.module_ble.R;
...
//			final OtaManager otaManager = weakReference.get();
                ...
                switch (msg.what) {
                    ...
                    case BleOtaUpdater.OTA_FAIL:
                        if (otaManager.mUpdateDialog != null) {
                            ...
                            builder.setPositiveButton(R.string.update_retry, (dialog, which) -> {
                                dialog.dismiss();
                                otaManager.retryUpdate(otaUpdater);
                            });
                            builder.setNegativeButton(R.string.update_cancel, (dialog, which) -> dialog.dismiss());
    ...
    private final SparseArray<BleOtaUpdater> mUpdateList = new SparseArray<>();
