...
public class ScanRecord {
    ...
    private ScanRecord(@org.jetbrains.annotations.Nullable List<ParcelUuid> serviceUuids,
    ...
    // Parse service UUIDs.
    private static void parseServiceUuid(byte[] scanRecord, int currentPos, int dataLength,
