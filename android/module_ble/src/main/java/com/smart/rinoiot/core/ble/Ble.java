 ...
 */
package com.smart.rinoiot.core.ble;
...
import com.smart.rinoiot.core.ble.callback.BleReadDescCallback;
import com.smart.rinoiot.core.ble.callback.BleReadRssiCallback;
import com.smart.rinoiot.core.ble.callback.BleScanCallback;
import com.smart.rinoiot.core.ble.callback.BleStatusCallback;
import com.smart.rinoiot.core.ble.callback.BleWriteCallback;
import com.smart.rinoiot.core.ble.callback.BleWriteDescCallback;
import com.smart.rinoiot.core.ble.callback.BleWriteEntityCallback;
import com.smart.rinoiot.core.ble.callback.wrapper.BluetoothChangedObserver;
import com.smart.rinoiot.core.ble.exception.BleException;
import com.smart.rinoiot.core.ble.model.BleDevice;
import com.smart.rinoiot.core.ble.model.EntityData;
import com.smart.rinoiot.core.ble.proxy.RequestImpl;
import com.smart.rinoiot.core.ble.proxy.RequestListener;
import com.smart.rinoiot.core.ble.proxy.RequestProxy;
import com.smart.rinoiot.core.ble.queue.RequestTask;
import com.smart.rinoiot.core.ble.queue.WriteQueue;
import com.smart.rinoiot.core.ble.queue.reconnect.DefaultReConnectHandler;
...
public final class Ble<T extends BleDevice> {
    ...
    public void closeAll() {
        ...
        if (!connectedDevices.isEmpty()) {
            for (T device : connectedDevices) {
                if (bleRequestImpl != null) {
                    bleRequestImpl.close(device.getBleAddress());
                }
            }
        }
    }
