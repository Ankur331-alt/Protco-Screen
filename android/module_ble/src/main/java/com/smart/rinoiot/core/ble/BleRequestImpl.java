...
import com.smart.rinoiot.core.ble.callback.wrapper.DescWrapperCallback;
...
import com.smart.rinoiot.core.ota.OtaListener;
import com.smart.rinoiot.module_ble.BuildConfig;
...
//                gatt.close();
//                BluetoothDevice device = gatt.getDevice();//清除蓝牙配对信息
//                if (device != null) {
