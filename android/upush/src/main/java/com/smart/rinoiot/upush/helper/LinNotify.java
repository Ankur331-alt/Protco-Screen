...
@SuppressLint({"WrongConstant", "InlinedApi", "ObsoleteSdkInt"})
...
//        channel.setVibrationPattern(new long[]{1000, 2000, 1000,3000});
    ...
    public static void show(Context context, int largeIcon,
        ...
        builder.setLargeIcon(BitmapFactory.decodeResource(context.getResources(), largeIcon == 0 ? R.drawable.ic_launcher : largeIcon)) //设置自动收报机和通知中显示的大图标。
